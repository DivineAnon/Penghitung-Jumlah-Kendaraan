...
path = ""
home = Tk()
home.title("Vehicle Detection 1.0")
home.geometry("300x300")
home.resizable(0,0)

Label(home, text="Automatic Vehicle Detection", font=("Verdana",15)).grid(row=0, column=1, ipadx=10, ipady=10)
text = StringVar()
Label(home, textvariable=text, font=("Verdana", 8)).grid(row=4, column=1,ipadx=10, ipady=10)

def openVideo():
    global path
    path = filedialog.askopenfilename(initialdir="input/", title="Select file", filetypes=[("avi","*.avi"),("mp4","*.mp4"), ("mkv","*.mkv") ])
    text.set(path+"\n selected")
    #filename.replace(filename, path)
    return path

def VehicleDetector(filepath):
    cnt_up = 0
    cnt_down = 0
    UpMTR = 0
    UpLV = 0
    ...
    while(cap.isOpened()):
        ...
        for i in vehicles:
            ...
            """
            cv2.putText(frame, str(i.getId()), (i.getX(),i.getY()),font,0.2,i.getRGB(),1,cv2.LINE_AA)
       ...
       # MTR_down = 'Down Motor: ' + str(DownMTR)
        ...
        cv2.putText(frame, MTR_up, (10, 40), font, 1, (255, 255, 255), 4, cv2.LINE_AA)
        cv2.putText(frame, MTR_up, (10, 40), font, 1, (0, 0, 255), 3, cv2.LINE_AA)
        cv2.putText(frame, LV_up, (10, 90), font, 1, (255, 255, 255), 4, cv2.LINE_AA)
        cv2.putText(frame, LV_up, (10, 90), font, 1, (0, 0, 255), 3, cv2.LINE_AA)
        cv2.putText(frame, HV_up, (10, 140), font, 1, (255, 255, 255), 4, cv2.LINE_AA)
        cv2.putText(frame, HV_up, (10, 140), font, 1, (0, 0, 255), 3, cv2.LINE_AA)
        ...
        cv2.putText(frame, LV_down, (10, 190), font, 1, (255, 255, 255), 4, cv2.LINE_AA)
        cv2.putText(frame, LV_down, (10, 190), font, 1, (255, 0, 0), 3, cv2.LINE_AA)
        cv2.putText(frame, HV_down, (10, 240), font, 1, (255, 255, 255), 4, cv2.LINE_AA)
        cv2.putText(frame, HV_down, (10, 240), font, 1, (255, 0, 0), 3, cv2.LINE_AA)
        #cv2.putText(frame, MTR_down, (10, 290), font, 1, (255, 255, 255), 4, cv2.LINE_AA)
        #cv2.putText(frame, MTR_down, (10, 290), font, 1, (255, 0, 0), 3, cv2.LINE_AA)

        cv2.imshow('Frame', cv2.resize(frame, (1080 , 500)))
...
button1 = Button(home, text="Insert Video", command=openVideo, width=16, height=1).grid(row=5, column=1,ipadx=10, ipady=20)
button2 = Button(home, text="Detect Vehicle", command=lambda: VehicleDetector(path), width=16, height=1).grid(row=6, column=1,ipadx=10, ipady=20)
